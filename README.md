...
# 🪨⛏️ My NuGet Packages
This repository contains the source code for the NuGet packages I use across my .NET applications. They are created with my own needs in mind, so unless you're using my projects, you probably don't need them. However, if you do find a use for any of the code here - help yourself!